...
NOTE: A module cannot contain another module. However a module can contain a text snippet. For information about text snippets, see xref:using_text_snippets_or_text_fragments_{context}[].
