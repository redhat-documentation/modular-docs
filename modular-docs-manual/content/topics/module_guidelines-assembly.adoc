...
If the assembly covers a task, start the title with a verb in the gerund form, such as Creating or Configuring, for example: _Encrypting block devices using LUKS_.
