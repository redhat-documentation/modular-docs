...
This section is optional. You can use it for pointing the reader to tasks that might follow after the current procedure. Place this section after the *Additional resources* section and use the *Next steps* heading. Alternatively, if the user needs to perform the next steps before the verification steps, place the section between the *Procedure* section and the *Verification* section.
