...
This section is optional. You can use it for pointing the reader to instructions covering tasks that might follow after the current procedure. Place this section after the Additional resources section with the *Next steps* heading. Alternatively, if the user should perform the next steps before the verification steps, place the section in between the Procedure section and the Verification steps section.
